...
export const DerivedFeaturesSchema = z.object({
  ...
  oilTempDeviationC: z.number().optional(),
  coolantTempDeviationC: z.number().optional(),
  vibrationDeviationMmS: z.number().optional(),
  expectedOilTempC: z.number().optional(),
  expectedCoolantTempC: z.number().optional(),
  expectedOilPressureKpa: z.number().optional(),
  expectedVibrationMmS: z.number().optional(),
